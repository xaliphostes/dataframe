 ...
 * @return GenSerie<T> Divergence scalar field (itemSize = 1)
 */
/**
 ...
 */
template <typename T>
GenSerie<T> divergence(const GenSerie<T> &field, const GenSerie<T> &coordinates,
                       T search_radius) {
    ...
    GenSerie<T> result(1, num_points);
 ...
 */
template <typename T>
GenSerie<T> divergence(const GenSerie<T> &field,
    ...
    GenSerie<T> result(1, field.count());
...
template <typename T> auto make_divergence(const GenSerie<T> &coordinates) {
